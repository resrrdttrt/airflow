...
transaction_topic = 'from_mysql_transaction'
amount_topic = 'from_mysql_amount'
db_config = {
    'host': '172.17.0.1',
    'port': '5433',
    'database': 'postgres',
...
dag = DAG(
    'sync_mysql_to_postgres_transaction_and_amount',
    default_args=default_args,
    description='Sync Customer Transaction and Amount Data in MySQL',
